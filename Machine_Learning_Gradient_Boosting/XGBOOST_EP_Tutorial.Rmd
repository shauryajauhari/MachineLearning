...
cat("The accuracy is", 100 - (min(xgbcv1$evaluation_log$test_rmse_mean)*100), ". Since we are using the corss-validation scheme, the test/validation data is derived from the train data (input) itself.")
